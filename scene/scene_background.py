...
class Scene_background:
    ...
    gaussians : GaussianModelBackground

    def __init__(self, cfg, gaussians : GaussianModelBackground, save_dir : str):
        """b
        ...
        self.gaussians.create_from_pcd(self.test_dataset.readPointCloud_scene(), spatial_lr_scale=self.cameras_extent, froze=False)
